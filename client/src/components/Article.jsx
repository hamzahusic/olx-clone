    ...
    return ( 
        <Link to={`/article/${id}`} className="shadow-md inline-block rounded-t-md min-h-fit overflow-hidden max-w-[280px] bg-white">
            <div className="relative max-h-[164px]">
                ...
                {edit && <button className="absolute top-2 left-1 bg-yellow-600 py-[13px] px-[14px] rounded-full" onClick={() => removeArticle(id)}><img src={editIcon} alt="" className="max-w-[16px]"/></button>}
            </div>
