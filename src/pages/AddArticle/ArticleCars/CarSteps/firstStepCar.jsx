        ...
        <div>
            ...
            <div className="flex flex-col py-2 gap-3">
                ...
                <div className="flex flex-col gap-1">
                        ...
                        <input type="text" value={model} onChange={(e) => setModel(e.target.value)}  className='bg-gray-100 outline-none p-3 rounded-md placeholder:text-gray-600 text-base' placeholder="Unesite model"/>
                </div>
            </div>
        </div>
     );
