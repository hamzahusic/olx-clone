            ...
            <div className="flex flex-col py-4 gap-3">
                ...
                <div className="flex justify-between items-end gap-5">
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <input type="number"  name="model"  className='bg-gray-50 border-[1px] border-gray-200 outline-none p-3 rounded-md placeholder:text-gray-600 text-base' placeholder="Unesite cijenu u KM"/>         
                    </div>
